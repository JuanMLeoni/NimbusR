test_that("Descarga exitosa y retorna un dataframe", {
  ...
  resultado <- getNH0910(archivo_temp)
...
test_that("Falla si destfile es vacío o inválido", {
  expect_error(getNH0910(""), "El parametro 'destfile' debe ser una cadena de texto no vacia")
  expect_error(getNH0910(NULL), "El parametro 'destfile' debe ser una cadena de texto no vacia")
  expect_error(getNH0910(123), "El parametro 'destfile' debe ser una cadena de texto no vacia")
})
